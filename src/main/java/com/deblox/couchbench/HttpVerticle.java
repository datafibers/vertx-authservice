...
//                        System.out.println(event);
                        ...
                        eventBus.send("login-handler", document, new Handler<Message<JsonObject>>() {
                            public void handle(Message<JsonObject> message) {
                                if (message.body().getBoolean("status")) {
        ...
        HttpServer server = vertx.createHttpServer().requestHandler(routeMatcher).listen(SERVER_PORT);
